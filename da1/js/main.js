...
function preload () {
	...
	/*
	for (var i=0; i<5; i++) {
		var redX = Phaser.Math.Between(10, 900);
		var redY = Phaser.Math.Between(0, 50);
		var redflask = setXY: { x: redX, y: redY, stepX: 50 }
		//this.redflasks.add(redflask);
	}
	*/
	...
	//this.physics.add.collider(stars, redflasks);
